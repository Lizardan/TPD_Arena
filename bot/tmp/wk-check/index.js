...
var BOT_COMMANDS = [{ command: "arena", description: "\u0412\u044B\u0439\u0442\u0438 \u043D\u0430 \u0430\u0440\u0435\u043D\u0443" }];
...
function arenaCard(arena) {
  return {
    inline_keyboard: [
      ...
      [
        {
          text: "\u{1F6D1} \u041E\u0444\u043D\u0443\u0442\u044C \u0432\u0441\u0435 \u0430\u0440\u0435\u043D\u044B \u0432 \u0447\u0430\u0442\u0435",
...
async function handleOffAll(bot, env, cq, chatId) {
  ...
  await bot.answerCallbackQuery(cq.id, "\u0410\u0440\u0435\u043D\u044B \u0437\u0430\u043A\u0440\u044B\u0442\u044B \u{1F6D1}");
